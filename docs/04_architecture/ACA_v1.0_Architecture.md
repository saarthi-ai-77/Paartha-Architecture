...
Full experimental detail: `docs/06_experiments/Completed.md` (EXP-018, EXP-010), `docs/11_mvp/ACA-MVP-001.md` Section 8.
...
**Current Status:** Active — v1.0, synthesized, partially implemented (ME-01/ME-03 tested at real scale by ACA-MVP-001 Benchmark A), audited once (Section 17), corrected twice against real-scale evidence (Section 18: EXP-018, then EXP-010).
**Historical Context:** Produced 2026-07-18 under a changed role (architecture synthesis rather than research), immediately following ARS-001 Section 7's required theoretical clarification on structural evaluation. Audited the same day per `docs/09_validation/IVS-001.md`'s prerequisite requirement. Section 18 added the same day, following ACA-MVP-001 Benchmark A's completion, then extended immediately after with EXP-010's result.
**Known Facts:** See Section 2's per-function evidence tags and Section 11's falsification table (now including EXP-018's ME-03 scope-narrowing and EXP-010's falsified minimal fix).
...
**References:** `docs/08_requirements/ARS-001.md` (Sections 2, 5, 6, 7), `docs/06_experiments/Completed.md` (EXP-001–004, EXP-009, EXP-018, EXP-010), `docs/04_architecture/ACA_v0.4_Architecture.md` (superseded, preserved), `docs/09_validation/IVS-001.md`, `docs/11_mvp/ACA-MVP-001.md`, `docs/03_foundations/{ACCEPTED,REJECTED,OPEN}.md`
