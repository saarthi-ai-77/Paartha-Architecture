...
Full experimental detail: `docs/06_experiments/Completed.md` (EXP-018, EXP-010, EXP-020), `docs/11_mvp/ACA-MVP-001.md` Sections 8-9.
...
**Current Status:** Active — v1.0, synthesized, partially implemented (ME-01/ME-03 and RC-01 both tested at real scale by ACA-MVP-001 Benchmarks A and B respectively), audited once (Section 17), corrected/extended three times against real-scale evidence (Section 18: EXP-018 negative, EXP-010 negative, EXP-020 decisively positive).
**Historical Context:** Produced 2026-07-18 under a changed role (architecture synthesis rather than research), immediately following ARS-001 Section 7's required theoretical clarification on structural evaluation. Audited the same day per `docs/09_validation/IVS-001.md`'s prerequisite requirement. Section 18 added 2026-07-22 following ACA-MVP-001 Benchmark A's completion, extended same day with EXP-010, extended again 2026-07-23 with EXP-020 (Benchmark B).
**Known Facts:** See Section 2's per-function evidence tags and Section 11's falsification table (now including EXP-018's ME-03 scope-narrowing and EXP-010's falsified minimal fix). RC-01/COMPOSE's real-scale confirmation (EXP-020) does not change its evidence tag (already Validated) but substantially extends its evidentiary base.
...
**Unknowns:** Section 12's six experiments (now superseded in priority order by IVS-001 §6's blast-radius ranking, itself due for revision per Section 18); Section 13's five named risks, especially whole-system integration, never yet attempted even in miniature. `docs/12_cognition/CTX-001.md` (2026-07-23) separately investigates whether a fourth state substrate is needed for context/reasoning-state — not adopted here, tagged Reasoned hypothesis in that document.
**References:** `docs/08_requirements/ARS-001.md` (Sections 2, 5, 6, 7), `docs/06_experiments/Completed.md` (EXP-001–004, EXP-009, EXP-018, EXP-010, EXP-020), `docs/04_architecture/ACA_v0.4_Architecture.md` (superseded, preserved), `docs/09_validation/IVS-001.md`, `docs/11_mvp/ACA-MVP-001.md`, `docs/12_cognition/CTX-001.md`, `docs/03_foundations/{ACCEPTED,REJECTED,OPEN}.md`
