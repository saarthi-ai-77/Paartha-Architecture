...
* **ARS-001 (`docs/08_requirements/ARS-001.md`):** first draft of the Architecture Requirement Specification, reducing ~30 candidate mechanisms across prior discussion to 15 requirements in 5 domains. Not yet reviewed or frozen. Its most consequential open question — whether SR-01 (the self-evaluation signal it identified as the single most load-bearing requirement) generalizes beyond EXP-001's narrow, fixed-threshold instance — is currently the most important unresolved question in the entire research program, ahead of EXP-005 through EXP-008.
